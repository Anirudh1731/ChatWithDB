...
# Set the page title with emojis
st.set_page_config(page_title="🤖 Langchain Chat with DB 📊")

# Your Streamlit app code goes here
st.title("Welcome to the Langchain Chat with DB App!")
st.write("This app allows you to chat with your database using Langchain.")
...
if user_query:
    ...
    with st.chat_message("assistant"):
        ...
        st.session_state.messages.append({"role": "assistant", "content": response})  # Fixed: Use "messages" (plural)
        st.write(response)